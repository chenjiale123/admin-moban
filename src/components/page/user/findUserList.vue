                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="用户账号" prop="loginid">
                            <el-input v-model="form.loginid" placeholder="请输入用户账号" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="区" prop="areaId">
                            <el-select v-model="form.areaId" placeholder="请输入区">
                                <el-option
...
export default {
    ...
    data() {
        return {
            ...
            // 表单校验
            rules: {
                loginid: [{ required: true, message: '用户账号不能为空', trigger: 'blur' }],
    ...
    methods: {
        ...
        imgPreview(file, fileList) {
            ...
            if (regex.test(fileName.toLowerCase())) {
                ...
                this.formData.append('frontCardImage', file.raw);
            } else {
        ...
        imgPreview1(file, fileList) {
            ...
            if (regex.test(fileName.toLowerCase())) {
                ...
                this.formData.append('backCardImage', file.raw);
        ...
        //查询性别字典值
        getGender() {
            findSelect({ dictionaryKey: 'gender' }).then(response => {
        ...
        handleUpdate(row) {
            ...
            getUser({ userid: this.user }).then(response => {
                ...
                this.form.cityId = String(response.data.userDetail.city);
                this.form.areaId = String(response.data.userDetail.area);
                ...
                this.imgUrl = this.baseUrl+response.data.userDetail.frontCardImage;
                this.imgUrl1 = this.baseUrl+response.data.userDetail.backCardImage;
